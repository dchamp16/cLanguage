...
public:
    ...
    Pet(string petName, string petGender, int petAge)
    {
        name = petName;
        gender = petGender;
        age = petAge;
...
public:
    ...
    */
    Dog(string dogBreed, string petName, string petGender, int petAge) : Pet(petName, petGender, petAge)
    {
        breed = dogBreed;
    }
...
public:
    ...
    Cat(string catBreed, string petName, string petGender, int petAge) : Pet(petName, petGender, petAge)
    {
        breed = catBreed;
    }
